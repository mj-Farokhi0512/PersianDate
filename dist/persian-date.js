           ...
           */
              ...
              },
              {
                ...
                value: function leap_persian(year) {
                  const leapers = [1, 5, 9, 13, 17, 22, 26, 30];
                  return !!leapers.find((item) => item == year % 33);
                },
              ...
              },
              {
                ...
                value: function persian_to_jd(year, month, day) {
                  var date = moment([year, month, day], "jYYYY/jMM/jDD")._d;
              ...
              },
              {
                ...
                value: function jd_to_persian(jd) {
                  ...
                  var millis = (jd - this.J1970) * 86400000;
